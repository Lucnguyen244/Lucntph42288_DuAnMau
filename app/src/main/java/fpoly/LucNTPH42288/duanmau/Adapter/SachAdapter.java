package fpoly.LucNTPH42288.duanmau.Adapter;
...
public class SachAdapter extends RecyclerView.Adapter<SachAdapter.ViewHoler> {
    ...
    public void onBindViewHolder(@NonNull ViewHoler holder, int position) {
        ...
        holder.txtnamxb.setText(String.valueOf(list.get(position).getNamxb()));
    ...
    public class ViewHoler extends RecyclerView.ViewHolder {
        ...
        TextView txtmas, txttens, txtgiat, txtloais, txttenloai, txtnamxb;
        ...
        public ViewHoler(@NonNull View itemView) {
            ...
            txtnamxb = itemView.findViewById(R.id.txtnamxb1);
    ...
    public void dialogupdatesach(Sach sach) {
        ...
        TextInputLayout in_Namxb = view.findViewById(R.id.in_updateNamxb);
        ...
        TextInputEditText ed_Namxb = view.findViewById(R.id.ed_updateNamxb);
        ...
        ed_Namxb.setText(String.valueOf(sach.getNamxb()));
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tensach.isEmpty() || checktien.isEmpty() || namxb.isEmpty()) {
                    ...
                    if (namxb.equals("")) {
                        in_Namxb.setError("Vui lòng không để nam xuat ban");
                    } else {
                    ...
                    boolean check = dao.update(sach.getMaSach(), tensach, tien, namxbb, maloai);
                    if (check) {
                        list.clear();
                        list = dao.getSachAll();
                        notifyDataSetChanged();

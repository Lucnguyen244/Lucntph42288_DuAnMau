...
public class ThanhVienAdapter extends RecyclerView.Adapter<ThanhVienAdapter.ViewHoler> {
    ...
    public void onBindViewHolder(@NonNull ViewHoler holder, int position) {
        ...
        holder.txtcccd.setText(list.get(position).getCccd());
...
//                                loadData();
    ...
    public class ViewHoler extends RecyclerView.ViewHolder {
        TextView txtmatv, txttetv, txtns, txtcccd;
        ImageButton btnlele;
        ...
        public ViewHoler(@NonNull View itemView) {
            ...
            txtcccd = itemView.findViewById(R.id.txtcccd1);
    ...
    private void dialogUpdate(ThanhVien tv) {
        ...
        TextInputEditText ed_txtcccd = view.findViewById(R.id.ed_updatecccd);
        ...
        TextInputLayout in_txtccd = view.findViewById(R.id.in_updatecccd);
        ...
        ed_txtcccd.setText(tv.getCccd());
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String hoten = ed_txtTenTV.getText().toString();
                String namsinh = ed_txtNamSinh.getText().toString();
                String cccd = ed_txtcccd.getText().toString();
                int id = tv.getMaTV();

                boolean check = dao.update(id, hoten, namsinh, cccd);
                if (hoten.isEmpty() || namsinh.isEmpty()) {
                    ...
                    if (cccd.equals("")) {
                        in_txtccd.setError("Vui lòng không để trống năm căn cước công dân");
                    } else {
